...
def get_insurance_product_by_id(product_id: str):
    """
    根据产品ID获取单个保险产品信息
...
def get_insurance_products():
    """
    获取所有可用的保险产品列表 - 现在只是返回产品ID和名称的简要列表
    """
    products = [
        {
            "id": "life_001",
...
tools = [
    {
        "type": "function",
        "function": {
            "name": "get_insurance_product_by_id",
            "description": "根据产品ID获取单个保险产品的完整信息，包括产品名称、类型、保额范围、年限范围等详细信息",
            "parameters": {
                "type": "object",
                "properties": {
                    "product_id": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "获取所有可用的保险产品列表，但只包含产品ID和名称的简要信息",
            "parameters": {
                "type": "object",
                "properties": {},
                "required": []
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "required": ["product_ids", "insured_amount", "years", "age"]
            }
        }
    }
]
...
# 工具函数映射
available_functions = {
    "get_insurance_product_by_id": get_insurance_product_by_id,
...
if __name__ == "__main__":
    ...
    # 示例1：查询产品列表
    # run_agent("你们有哪些保险产品？", model="qwen-plus")
