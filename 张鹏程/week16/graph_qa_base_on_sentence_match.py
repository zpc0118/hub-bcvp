...
class GraphQA:
    def __init__(self):
        self.graph = Graph("http://localhost:7474", auth=("neo4j", "neo4j123"))
...
if __name__ == "__main__":
    graph = GraphQA()
    res = graph.query("刘备的籍贯是什么")
    print(res)
    res = graph.query("刘备的身高是多少")
    print(res)
    res = graph.query("刘备和关羽是什么关系")
    print(res)
    res = graph.query("刘备的妻子是谁")
    print(res)